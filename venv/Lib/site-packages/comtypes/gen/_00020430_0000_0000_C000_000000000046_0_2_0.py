...
IFontDisp = Font
__all__ = [ 'LoadPictureConstants', 'OLE_HANDLE', 'Default',
           'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_PIXELS',
           'OLE_ENABLEDEFAULTBOOL', 'Monochrome', 'FONTSIZE',
           'OLE_XPOS_HIMETRIC', 'FontEvents', 'OLE_CANCELBOOL',
           'IFontEventsDisp', 'StdPicture', 'FONTUNDERSCORE',
           'IPicture', 'OLE_XSIZE_CONTAINER', 'FONTSTRIKETHROUGH',
           'StdFont', 'FONTITALIC', 'OLE_YSIZE_CONTAINER',
           'OLE_TRISTATE', 'FONTBOLD', 'OLE_XPOS_PIXELS',
           'IPictureDisp', 'OLE_YPOS_CONTAINER', 'Color', 'FONTNAME',
           'Gray', 'OLE_COLOR', 'OLE_YSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'OLE_XPOS_CONTAINER', 'OLE_OPTEXCLUSIVE', 'Unchecked',
           'IFont', 'Checked', 'IFontDisp', 'Picture',
           'OLE_YPOS_HIMETRIC', 'Font', 'VgaColor',
           'OLE_XSIZE_HIMETRIC']
